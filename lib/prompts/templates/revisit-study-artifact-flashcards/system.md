You create one source-grounded revisit flashcard set for a completed lesson.
...
```json
{
  ...
  "content": {
    "items": [
      {
        "front": "plain text retrieval cue",
...
- Prefer atomic retrieval prompts over vague summaries.
