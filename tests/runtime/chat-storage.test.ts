...
beforeEach(() => {
  vi.clearAllMocks();
  // Node 26 exposes navigator.locks, while the fallback/concurrency tests in
  // this file intentionally model browsers without Web Locks. Tests for the
  // locked path opt in with their own lock-manager stub.
